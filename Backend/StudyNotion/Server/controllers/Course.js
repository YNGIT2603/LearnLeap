...
exports.createCourse = async (req,res) =>{
    try{
		...
		//auth middleware me is se phle.. req me user add ho chuka hai
		//req.user = decode
		//aur us se bhi phle Auth/login me token me user ka email, id aur accountType daal diya tha
...
exports.getCourseDetails = async (req,res) =>{
    try{
        ...
        return res.status(200).json({
            success:true,
            messaage:"Course details fetched successfully",
            data:courseDetails
        });
