...
const Home = () => {
  return (
    <div>
        {/* SECTION1 */}
        <div className='relative mx-auto flex flex-col items-center justify-between w-11/12
        text-white'>
            <Link to={"/signup"}>

                <div className='group mt-16 p-1 mx-auto rounded-full bg-richblue-800 font-bold text-richblack-200
                transitions-all duration-200 hover:scale-95 w-fit'>
                    <div className='flex items-center gap-2 rounded-full px-10 py-2 transition-all
        ...
        {/* SECTION 3 */}
        <div className='w-11/12 mx-auto flex max-w-maxContent flex-col items-center justify-between gap-8
